...
def run(cfg: PhysicsNeMoConfig) -> None:
    ...
    # Raw original dataset should be a dictionary with:
    # key = "<name of input>" : value = tensor of input data
    # key = "<name of output>" : value = tensor of output data

    # invar_train.shape = (1000, 1, 241, 241) --> permeability fields, K
    # outvar_train.shape = (1000, 1, 241, 241) --> pressure fields, U
    # so "coeff" = K and "sol" = U ?
    ...
    # make datasets
    # K and U are grids of values that we are storing in dictionaries invar_train and outvar_train
    # This here is a utility for grabbing data from grids inside dictionaries
    # If our data is not in grid form, then we don't need to use this utility wrapper
    ...
    # This constraint just ensures that the neural operator is trained against grid data
